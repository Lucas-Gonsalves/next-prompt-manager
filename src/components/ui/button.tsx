...
const buttonVariants = cva(
  cn(
    "cursor-pointer border-[#424242] inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all",
  ...
  ),
  {
    variants: {
      variant: {
        ...
        outline:
          "border bg-gray-700 text-white hover:bg-gray-600 disabled:hover:bg-gray-700",
        secondary:
